...
includeContent={"type":"org_openCiLife_post", "category":"AAdopter_chat", "specificClass":"fourPerRow cardAnimal animalAAdopter", "display":{"type":"card", "content":"link"}}
category=typeAnimal
displayDate=false
status=published
...
~~~~~~
**Notre mission de sauvetage des chats implique de les sociabiliser au mieux et de les faire adopter dans les meilleures conditions. Nos familles d’accueil ont à cœur de rassurer, soigner, éduquer et aimer tous les animaux qui leur sont confiés, en attendant qu’ils trouvent leur famille pour la vie.**
